...
var _getSlots = _interopRequireDefault(require("vue-docgen-api/dist/utils/getSlots"));

var _getDocFile2 = _interopRequireDefault(require("vue-docgen-api/dist/utils/getDocFile"));
...
function () {
  ...
  (0, _createClass2.default)(stateDoc, [{
    ...
    key: "saveStoreModule",
    value: function saveStoreModule(source, file) {
      if (this.isMainComponent(file) && this.sourceComponent !== source) {
        this.jscodeRequest = source;
        if (file.slice(file.lastIndexOf(".") + 1) === "ts") {
          this.jscodeLang = "ts";
        } else {
          this.jscodeLang = "js";
        }
